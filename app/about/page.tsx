...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Harris Landscaping & Gardens — over 15 years of hands-on landscaping experience across South-West Sydney. Fully insured, quality-focused local team serving Campbelltown, Camden, Narellan, and beyond.",
};
        ...
        items={[
          {
            ...
            description: "With 15-plus years working across South-West Sydney, we bring deep local knowledge and proven expertise to every job we take on.",
          },
          {
            title: "Clear Communication",
            description: "We keep you informed at every stage — from your initial quote through to project completion — so there are never any surprises.",
          },
          {
            title: "Quality That Lasts",
            description: "We use premium materials and proven techniques to ensure every project stands the test of time and adds real value to your property.",
          },
        ]}
