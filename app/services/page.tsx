        ...
        items={[
          {
            ...
            description:
              'From driveways to entertaining areas, we lay high-quality pavers that are as durable as they are visually impressive.',
          },
          {
            ...
            description:
              'We supply and install premium turf varieties suited to South-West Sydney conditions, giving you a lush lawn that lasts.',
          },
          {
            ...
            description:
              'Our retaining walls are engineered for stability and built to complement your landscape, handling sloped blocks with ease.',
          },
          {
            ...
            description:
              'We design and build custom timber and composite decks that extend your living space and add significant value to your home.',
          },
          {
            ...
            description:
              'Our garden transformations combine planting, edging, mulching, and design to create outdoor spaces you will love spending time in.',
          },
          {
            ...
            description:
              'Need everything done? We manage complete outdoor renovations from initial design through to the finishing touches, all under one roof.',
          },
        ]}
