        ...
        items={[
          {
            name: 'Sarah M.',
            review:
              'Harris Landscaping completely transformed our backyard. The team was professional, communicative, and the result exceeded our expectations.',
            location: 'Campbelltown',
          },
          {
            name: 'James T.',
            review:
              'Outstanding workmanship on our driveway paving. Finished on time and on budget. Highly recommend to anyone in South-West Sydney.',
            location: 'Camden',
          },
          {
            name: 'Lisa R.',
            review:
              "We had a full outdoor makeover done and couldn't be happier. The team kept us informed every step of the way and the quality is brilliant.",
            location: 'Narellan',
          },
        ]}
